    ...
    return (
        <aside className="h-full w-full rounded-2xl bg-[#001A4C] p-6 text-white">
            <div className="flex items-center gap-2">
                ...
                <h3 className="text-[18px] font-semibold">캠페인 요약</h3>
            </div>

            <div className="mt-5">
                <div className="text-[14px] text-white/80">진행 중인 캠페인 수</div>
                <div className="text-[36px] font-bold leading-tight">8</div>
            </div>

            <div className="mt-6">
                <div className="text-[14px] text-white/80">총 타겟 고객수</div>
            ...
            <div className="mt-8 rounded-2xl bg-white/10 p-6">
                <div className="grid grid-cols-2 gap-y-6 gap-x-6 relative text-white">
                    ...
                    <div>
                        <div className="text-[14px] text-white/80">오픈율</div>
                        <div className="mt-2 text-[22px] font-bold">
                            458 <span className="text-[14px]">(14.48%)</span>
                        </div>
                    </div>

                    <div>
                        <div className="text-[14px] text-white/80">ROI</div>
                        <div className="mt-2 text-[22px] font-bold">+ 324%</div>
                    </div>

                    <div>
                        <div className="text-[14px] text-white/80">클릭율</div>
                        <div className="mt-2 text-[22px] font-bold">
                            243 <span className="text-[14px]">(14.48%)</span>
                        </div>
                    </div>

                    <div>
                        <div className="text-[14px] text-white/80">구매 전환율</div>
                        <div className="mt-2 text-[22px] font-bold">+ 24.5%</div>
                    </div>
                </div>
            </div>

            <div className="mt-8 rounded-2xl bg-white p-5 text-[#111]">
                <div className="flex items-center gap-2 font-semibold">
                    <img src={aiIcon} alt="" className="w-5 h-5" />
                    AI 요약
                </div>
                <p className="mt-3 text-[14px] leading-relaxed text-[#444]">

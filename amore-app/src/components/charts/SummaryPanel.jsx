...
export default function SummaryPanel({ aiSummary }) {
    return (
        <aside
     className={[
       ...
       >
            ...
            <div className="mt-5">
                <div className="text-[16px] text-white">진행 중인 캠페인 수</div>
                <div className="text-[36px] font-bold leading-tight">8</div>
            </div>

            <div className="mt-6">
                <div className="text-[16px] text-white">총 타겟 고객수</div>
            ...
            <div className="mt-8 rounded-2xl bg-white/10 p-6">
                <div className="grid grid-cols-2 gap-y-6 gap-x-6 relative text-white">
                    ...
                    <div>
                        <div className="text-[16px] text-white font-medium">오픈율</div>
                    ...
                    <div>
                        <div className="text-[16px] text-white font-medium">ROI</div>
                        <div className="mt-2 text-[24px] font-bold">+ 324%</div>
                    </div>

                    <div>
                        <div className="text-[16px] text-white font-medium">클릭율</div>
                        <div className="mt-2 text-[24px] font-bold">
                    ...
                    <div>
                        <div className="text-[16px] text-white font-medium">구매 전환율</div>
